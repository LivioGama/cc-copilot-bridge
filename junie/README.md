> **Vendored from [fabienfleureau/junie-api](https://github.com/fabienfleureau/junie-api).** This is an embedded copy used as a backend provider for `cc-copilot-bridge`. Upstream license: MIT (see LICENSE file below). Bridge integration: `claude-switch junie` or `ccj` alias.
